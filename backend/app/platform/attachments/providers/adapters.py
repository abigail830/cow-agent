...
from app.platform.attachments.storage import is_image_mime
...
def azure_openai_files_url(base_url: str, api_version: str) -> str:
...
class OpenAIAttachmentAdapter:
    ...
    async def upload(self, *, filename: str, mime_type: str, data: bytes) -> UploadedProviderFile:
        ...
        url = azure_openai_files_url(base_url, files_api_version)
