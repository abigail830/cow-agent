...
from app.agent_specific.proposal.fee_table import format_money, row_frequency_columns, row_total_annualized
from app.agent_specific.proposal.footnotes import normalize_footnote
from app.agent_specific.proposal.pricing_rules import coerce_price_amount, fee_table_amount_display, normalize_pricing_type
...
def _preview_primary(source: dict[str, Any], layout: dict[str, Any]) -> str:
    from app.agent_specific.proposal.fee_table import service_column_flags
...
def validate_fee_row_patches(patch: list[dict[str, Any]]) -> None:
    from app.agent_specific.proposal.draft import DraftPatchError
