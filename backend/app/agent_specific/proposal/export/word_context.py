...
from app.agent_specific.proposal.fee_table import format_money, payment_summary_footer, row_total_annualized
from app.agent_specific.proposal.footnotes import apply_footnote_numbers, collect_footnotes
from app.agent_specific.proposal.loaders import load_template_yaml, read_static_block
from app.agent_specific.proposal.placeholders import (
    apply_template_placeholders,
    resolve_section_source_content,
    selected_package_names,
)
from app.agent_specific.proposal.word_markdown import markdown_to_plain as _markdown_to_plain
