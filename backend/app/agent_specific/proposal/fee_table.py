...
def build_fee_service_cell_html(
    ...
    *,
    ...
    if footnote_num:
        from app.agent_specific.proposal.footnotes import footnote_superscript_html
...
def _frequency_row_display(row: dict[str, Any]) -> tuple[dict[str, str | None], str | None, str | None]:
    ...
    from app.agent_specific.proposal.pricing_rules import normalize_pricing_type, uses_fee_raw_display
